...
//		设置路径映射，注意这里要用LinkedHashMap 保证有序
		...
		filterChainDefinitionMap.put("/Corporation/**", "anon");
		filterChainDefinitionMap.put("/Home/**", "anon");
		filterChainDefinitionMap.put("/PersonInfo/**", "anon");
		filterChainDefinitionMap.put("/Communicate/**", "anon");
		filterChainDefinitionMap.put("/ReplyUser/**", "anon");
		filterChainDefinitionMap.put("/Activity/**", "anon");
		filterChainDefinitionMap.put("/Disscuss/**", "anon");
		//放验证码
