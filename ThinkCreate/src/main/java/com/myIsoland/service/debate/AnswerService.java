...
public interface AnswerService extends IService<Answer> {
    ...
    ResultSet<Answer> GetAnswersByDate(String topicId, Date date, int start, int limit);

    ResultSet<Answer> GetAdvanceAnsByTopicId(String topicId, Date date, int likes, int recoms, int start, int limit);
