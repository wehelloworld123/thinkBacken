...
public class TopicServiceImpl extends ServiceImpl<TopicMapper,Topic> implements TopicService{
    ...
    public Topic GetCurtTopic() {
            ...
            wrapper.eq(Topic::getFinish,0)
                    ...
                    .select(Topic::getUid, Topic::getTitle,Topic::getLabel1,Topic::getLabel2,Topic::getLabel3, Topic::getThinking, Topic::getFlexibility, Topic::getLogicality, Topic::getTotalDiff, Topic::getContent, Topic::getYear, Topic::getFinish, Topic::getPeriod, Topic::getViews, Topic::getBelongName)
    ...
    public ResultSet<Topic> GetTopicList(int startIndex, int pageSize) {
        ...
        wrapper.lambda()
                ...
                .select(Topic::getUid, Topic::getTitle, Topic::getLabel1,Topic::getLabel2,Topic::getLabel3,Topic::getYear, Topic::getPeriod, Topic::getThinking, Topic::getLogicality, Topic::getFlexibility, Topic::getTotalDiff);
