...
public class CaptchaController
{
    ...
    public ModelAndView getKaptchaImage(HttpServletRequest request, HttpServletResponse response, String type)
    {
        ...
        try
        {
            ...
            response.setHeader("sessionId",request.getRemoteHost()+"");
            //return a jpeg 
            ...
            System.out.println(request.getRemoteHost()+":remotePort");
            redisCacheService.set(request.getRemoteHost()+"",answer,100, TimeUnit.SECONDS);
