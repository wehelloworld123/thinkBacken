...
public class DisscussController {
    ...
    public Object ReadNewDiscuss(String date,Integer startIndex,Integer pageSize,String source,boolean isLogin){
        String userId = null;
        if(isLogin){
            userId = ShiroUtils.getUserId();
        }
        ResultSet<Disscuss> result = disscussService.GetNewDateDisscuss(userId, DateUtils.parseDate(date),startIndex,pageSize,source);
    ...
    public Object ReadConcernDisByDate(String date,Integer startIndex,Integer pageSize,String source){
        return AjaxResult.success(disscussService.GetConcernDis(ShiroUtils.getUserId(), DateUtils.parseDate(date),startIndex,pageSize,source));
    }
