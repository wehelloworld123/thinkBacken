...
public class SmsUtil {
    public static void applySmsTemplate()
    {
        try {
            /* 必要步骤：
          ...
          //  httpProfile.setProxyPort(port);
            ...
            Long smstype = new Long(0);
            req.setSmsType(smstype);

            /* 是否国际/港澳台短信：0：表示国内短信，1：表示国际/港澳台短信。 */
            Long international = new Long(0);
            req.setInternational(international);

            /* 模板备注：例如申请原因，使用场景等 */
            String remark = "应用程序登陆短信验证码";
    ...
    public static Map<String,Object> sendSms(String phoneNo){
        ...
        try {
           ...
           // String appid = "1400009099";
            ...
            //String senderid = "xxx";
           // req.setSenderId(SmsConfig.getSign());
          ...
          //  req.setExtendCode(extendcode);
           ...
           // String templateID = "400000";
            ...
            String[] phoneNumbers = {"+86"+phoneNo};
            req.setPhoneNumberSet(phoneNumbers);

            /* 模板参数: 若无模板参数，则设置为空*/
            String verifyCode = CaculateUtils.getNonce_str(4);//验证码
            String[] templateParams = {verifyCode,"1"};
