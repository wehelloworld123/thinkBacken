...
public class PersonalController {
    ...
    @PostMapping("modifyUserInfor")
    public Object ModifyUserInfor(String nickname, int sex, String area, String description, @RequestParam(value = "username",required = false) String username, @RequestParam(value = "imagefile",required = false) MultipartFile imagefile){
